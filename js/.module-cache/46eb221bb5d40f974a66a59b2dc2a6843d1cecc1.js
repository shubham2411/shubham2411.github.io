var Teams = React.createClass({displayName: "Teams",
  ...
  render: function(){
    ...
    var lclPlayers = lclPlayers.map(function(row){
    ...
    var visPlayers = visPlayers.map(function(row){
    ...
    return (
      ...
      React.createElement("div", {style: self.teamName1}, 
      lcl_team
      ), 
      React.createElement("div", {style: self.players}, 
      players
      )
      )
    );
