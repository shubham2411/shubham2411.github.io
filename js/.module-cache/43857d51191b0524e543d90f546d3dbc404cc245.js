...
var Commentaries = React.createClass({displayName: "Commentaries",
  ...
  render: function(){
   ...
   var comments = sorted.map(function(oneComment){
       ...
       React.createElement(ReactCSSTransitionGroup, {transitionName: "comment", transitionAppear: true}, 
        React.createElement("div", null, oneComment.minute, " - ", oneComment.comment)
       ), 
