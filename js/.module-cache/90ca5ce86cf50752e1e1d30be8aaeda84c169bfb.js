  ...
  render: function(){
    ...
    if(this.state.rows.length===0){
      ...
      return(
        ...
        React.createElement("a", {style: this.comm_btn3, onClick: self.handleclick.bind(self, teamBtn), key: teamBtn}, "Stats")
        ), 
      ...
      return(
        ...
        React.createElement("a", {style: this.comm_btn1, onClick: self.handleclick.bind(self, com), key: com}, "Commentary"), 
        React.createElement("a", {style: this.comm_btn2, onClick: self.handleclick.bind(self, stat), key: stat}, "Stats"), 
        React.createElement("a", {style: this.comm_btn3, onClick: self.handleclick.bind(self, teamBtn), key: teateamBtnms}, "Stats")
        )
        )
      );
    }
...
render: function(){
  ...
  var rows1 = lclPlayers.map(function(row){
