  ...
  render: function(){
    ...
    var rows = this.state.rows.map(function(row){
      ...
      return(
        ...
        React.createElement("td", null, React.createElement("div", null, lcl_team)), 
        React.createElement("td", null, " vs "), 
        React.createElement("td", null, React.createElement("div", null, vis_team)), React.createElement("br", null)
        )
        )
        )
      );
